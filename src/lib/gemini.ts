...
CRITICAL: If the question contains diagrams, you MUST generate and embed them as Excalidraw JSON format directly into the \`question_statement\`.
DO NOT use separate fields like \`has_image\` or \`image_description\`; they are not supported. If no diagram exists, do not include any Excalidraw JSON.
